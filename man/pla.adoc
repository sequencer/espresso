...
*.mv [num_ var] [num_ binary_ var] [d1] . . . [dn]*::
  Specifies the number of variables (num_ var), the number of binary
  variables (num_ binary_ var), and the size of each of the
